                ...
                itemBuilder: (_, i) {
                  ...
                  return Draggable<int>(
                    ...
                    feedback: Material(
                      ...
                      child: Container(
                        width: 60, height: 60,
                        decoration: BoxDecoration(color: p.color, shape: BoxShape.circle, boxShadow: [BoxShadow(color: p.color.withValues(alpha: 0.6), blurRadius: 16)]),
                        child: Center(child: Text(p.emoji, style: const TextStyle(fontSize: 30))),
                      ),
                    ),
                    childWhenDragging: Opacity(opacity: 0.3, child: _inventoryItem(p)),
