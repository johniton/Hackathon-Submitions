...
class _MapJobsPageState extends State<MapJobsPage> with TickerProviderStateMixin {
  ...
  static const _jobs = [
    {'role': 'Flutter Dev', 'company': 'Razorpay', 'salary': '₹18–24 LPA', 'dist': '1.2 km', 'commuteCar': '8 min', 'commuteTransit': '18 min', 'x': 0.55, 'y': 0.35, 'type': 'Onsite', 'exp': '1-3 yr', 'match': 95, 'stack': 'Flutter, Dart, Firebase'},
    {'role': 'SDE-1', 'company': 'Meesho', 'salary': '₹12–18 LPA', 'dist': '3.7 km', 'commuteCar': '15 min', 'commuteTransit': '28 min', 'x': 0.3, 'y': 0.5, 'type': 'Hybrid', 'exp': 'Fresher', 'match': 87, 'stack': 'React, Node.js'},
    {'role': 'Frontend Dev', 'company': 'CRED', 'salary': '₹20–28 LPA', 'dist': '5.1 km', 'commuteCar': '22 min', 'commuteTransit': '35 min', 'x': 0.72, 'y': 0.6, 'type': 'Onsite', 'exp': '3-5 yr', 'match': 79, 'stack': 'React, TypeScript'},
    {'role': 'DevOps Eng', 'company': 'Groww', 'salary': '₹15–22 LPA', 'dist': '7.8 km', 'commuteCar': '25 min', 'commuteTransit': '40 min', 'x': 0.2, 'y': 0.28, 'type': 'Remote', 'exp': '1-3 yr', 'match': 72, 'stack': 'AWS, Docker, K8s'},
    {'role': 'ML Engineer', 'company': 'Flipkart', 'salary': '₹25–35 LPA', 'dist': '4.3 km', 'commuteCar': '18 min', 'commuteTransit': '30 min', 'x': 0.65, 'y': 0.75, 'type': 'Hybrid', 'exp': '3-5 yr', 'match': 68, 'stack': 'Python, TensorFlow'},
    {'role': 'iOS Dev', 'company': 'PhonePe', 'salary': '₹16–24 LPA', 'dist': '2.5 km', 'commuteCar': '10 min', 'commuteTransit': '20 min', 'x': 0.42, 'y': 0.42, 'type': 'Onsite', 'exp': '1-3 yr', 'match': 65, 'stack': 'Swift, UIKit'},
  ];

  List<Map<String, dynamic>> get _filteredJobs {
    return _jobs.where((j) {
      final dist = double.parse((j['dist'] as String).replaceAll(' km', ''));
