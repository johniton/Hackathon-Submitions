  ...
  Future<void> _generateDigest() async {
    ...
    try {
      ...
      final resp = await http.post(
        Uri.parse('${AppConfig.baseUrl}/ai-tools/tech-feed'),
      ...
      if (resp.statusCode == 200) {
        ...
        setState(() => _digestText = data['digest']);
      } else {
        throw Exception('Backend HTTP ${resp.statusCode}: ${resp.body}');
      }
    } catch (e) { 
      setState(() => _digestText = 'Error generating digest: $e'); 
    }
