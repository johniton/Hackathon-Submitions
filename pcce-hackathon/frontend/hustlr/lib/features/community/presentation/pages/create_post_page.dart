          ...
          Padding(
            ...
            child: GestureDetector(
              onTap: () async {
                ...
                final current = prefs.getInt('community_posts_count') ?? 0;
                await prefs.setInt('community_posts_count', current + 1);
                if (context.mounted) {
                  ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text('Post published successfully!'), backgroundColor: AppColors.success));
