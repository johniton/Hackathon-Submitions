...
import 'package:hustlr/features/skill_swap/presentation/widgets/peer_profile_bottom_sheet.dart';
...
class _SkillSwapDashboardBodyState extends State<SkillSwapDashboardBody>
              ...
              if (prov.pendingRequests.isNotEmpty)
                SliverList(
                  delegate: SliverChildBuilderDelegate(
                    (context, index) => _buildPendingRequestCard(prov, prov.pendingRequests[index], isDark),
                    childCount: prov.pendingRequests.length,
                  ),
                ),
  ...
  Widget _buildPendingRequestCard(SkillSwapProvider prov, SwapMatch match, bool isDark) {
    return Padding(
      ...
      child: Container(
        decoration: BoxDecoration(
          ...
          boxShadow: [BoxShadow(color: AppColors.warning.withValues(alpha: 0.1), blurRadius: 20, offset: const Offset(0, 8))],
        ),
        child: Padding(
          ...
          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            Row(children: [
              Container(
                ...
                child: const Text('⏳  Pending Request', style: TextStyle(color: AppColors.warning, fontSize: 11, fontWeight: FontWeight.bold))),
            ]),
            const SizedBox(height: 14),
            GestureDetector(
              behavior: HitTestBehavior.opaque,
              onTap: () => PeerProfileBottomSheet.show(context, match.peer),
              child: Row(children: [
                CircleAvatar(radius: 22, backgroundColor: AppColors.primary.withValues(alpha: 0.1),
                  child: Text(match.peer.avatar, style: const TextStyle(color: AppColors.primary, fontWeight: FontWeight.bold, fontSize: 16))),
                const SizedBox(width: 12),
                Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  Text(match.peer.name, style: TextStyle(color: isDark ? Colors.white : Colors.black, fontWeight: FontWeight.bold, fontSize: 15), maxLines: 1, overflow: TextOverflow.ellipsis),
                  Text('Wants to learn ${match.teachingSkill}',
                    style: const TextStyle(color: AppColors.textSecondaryLight, fontSize: 12), maxLines: 1, overflow: TextOverflow.ellipsis),
                ])),
                ElevatedButton.icon(
                onPressed: () => prov.acceptRequest(match),
          ...
          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            GestureDetector(
              ...
              child: Row(children: [
                ...
                const SizedBox(width: 12),
                Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  Text(match.peer.name, style: const TextStyle(color: Colors.white, fontWeight: FontWeight.bold, fontSize: 15), maxLines: 1, overflow: TextOverflow.ellipsis),
    ...
    return Padding(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          gradient: LinearGradient(
            colors: isDark 
                ...
                : [AppColors.primary.withValues(alpha: 0.1), AppColors.accent.withValues(alpha: 0.02)],
        ...
        child: Column(children: [
          ...
          Text('No matches yet', style: TextStyle(color: isDark ? Colors.white : Colors.black, fontWeight: FontWeight.bold, fontSize: 16)),
          const SizedBox(height: 8),
          const Text('Add your skills below to find people to swap with! As soon as we find a match, they will appear right here.',
          ...
          return Padding(
            ...
            child: Container(
              ...
              child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                GestureDetector(
                  behavior: HitTestBehavior.opaque,
                  onTap: () => PeerProfileBottomSheet.show(context, m.peer),
                  child: Row(children: [
                    ...
                    const SizedBox(width: 12),
                    Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                      Text(m.peer.name, style: const TextStyle(fontWeight: FontWeight.bold, fontSize: 15), maxLines: 1, overflow: TextOverflow.ellipsis),
                      Text(m.peer.city, style: const TextStyle(color: AppColors.textSecondaryLight, fontSize: 12), maxLines: 1, overflow: TextOverflow.ellipsis),
                    ])),
                    Container(
  ...
  Widget _exchangeSide(IconData icon, String label, String skill, Color color) {
    return Padding(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        Text(skill, style: TextStyle(fontWeight: FontWeight.bold, fontSize: 13, color: color), maxLines: 1, overflow: TextOverflow.ellipsis),
      ]),
    );
  }
