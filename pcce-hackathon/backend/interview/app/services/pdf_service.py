...
async def generate_pdf(resume_json: dict, template_name: str = "ats_safe") -> bytes:
    """Generate PDF bytes from resume JSON using local HTML templating."""
    from weasyprint import HTML

    # Use deterministic local rendering instead of LLM to avoid 413 Payload Too Large
    html_content = render_resume_html(resume_json, template_name)
